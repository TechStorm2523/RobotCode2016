 ...
 */
public class InputJoystickINFO extends GenericHID {
   ...
   *        into.
   */
  public InputJoystickINFO(final int port) {
   ...
   */
  protected InputJoystickINFO(int port, int numAxisTypes, int numButtonTypes) {
